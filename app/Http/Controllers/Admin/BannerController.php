    ...
    public function store(Request $request)
    {
        $validate = Validator::make(
            ...
            [
                ...
                'image_mobile' => 'required|file|mimes:jpg,jpeg,png,gif,webp|max:10240',
            ]
        );
        ...
        try {
            ...
            if ($request->image_mobile) {
                // FileHelper::uploadFile($request->image, 'banners', $object->id, ThisModel::class, 'image', 99);
                FileHelper::uploadFileToCloudflare($request->image_mobile, $object->id, ThisModel::class, 'image_mobile');
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        $validate = Validator::make(
            ...
            [
                ...
                'image_mobile' => 'nullable|file|mimes:jpg,jpeg,png,webp|max:10240',
            ]
        );
        $json = new stdClass();
        ...
        try {
            ...
            if ($request->image_mobile) {
                ...
                if ($object->image_mobile) {
                    // FileHelper::forceDeleteFiles($object->image->id, $object->id, ThisModel::class, 'image');
                    FileHelper::deleteFileFromCloudflare($object->image_mobile, $object->id, ThisModel::class, 'image_mobile');
                }
