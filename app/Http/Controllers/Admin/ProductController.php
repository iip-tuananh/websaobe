...
class ProductController extends Controller
{
    ...
    public function store(ProductStoreRequest $request)
    {
        ...
        try {
            ...
            FileHelper::uploadFileToCloudflare($request->banner_mobile, $object->id, ThisModel::class, 'banner_mobile');
        ...
        try {
            ...
            if($request->banner_mobile) {
                if($object->banner_mobile) {
                    FileHelper::deleteFileFromCloudflare($object->banner_mobile, $object->id, ThisModel::class, 'banner_mobile');
                }
                FileHelper::uploadFileToCloudflare($request->banner_mobile, $object->id, ThisModel::class, 'banner_mobile');
            }
    ...
    public function searchProducts(Request $request) {
        $data = Product::searchByFilter($request);
