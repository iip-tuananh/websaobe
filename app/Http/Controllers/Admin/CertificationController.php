...
use App\Model\Admin\Certification as ThisModel;
...
{
    protected $view = 'admin.certifications';
    protected $route = 'certifications';
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($request->image) {
                FileHelper::uploadFileToCloudflare($request->image, $object->id, Certification::class, 'image');
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if($request->image) {
                ...
                FileHelper::uploadFileToCloudflare($request->image, $object->id, \App\Model\Admin\Certification::class, 'image');
            }
