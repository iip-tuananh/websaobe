<div id="popup-cart-mobile" class="popup-cart-mobile">
    <div class="header-popcart">
        ...
        <div class="media-content bodycart-mobile" ng-repeat="item in cart.items">
            ...
            <div class="body_content"><h4 class="product-title"><a href="/chi-tiet-san-pham/<% item.attributes.slug %>"
                                                                   title="<% item.name %>"><% item.name %></a></h4><span class="variant"></span>

                <div class="product-new-price">
                    <b ng-if="item.price && item.price > 0"><% item.price | number:0 %> ₫</b>
                    <b ng-if="!item.price || item.price <= 0">Liên hệ</b>
                </div>
        ...
        <div class="bottom-action">
            ...
            <a href="{{ route('cart.checkout') }}" class="checkout btn btn-primary" title="Thanh toán ngay">
                Thanh toán ngay
            </a>
        </div>
    </div>
