...
<div class="row">
    <div class="col-lg-8">
        <div class="custom-card">
            ...
            <div class="form-group mb-4">
                ...
                <textarea ck-editor rows="4" class="form-control" ng-model="form.body"></textarea>
                <div class="invalid-feedback d-block"><% errors.body[0] %></div>
            </div>
    ...
    <div class="col-lg-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group text-center">
                    <div class="main-img-preview">
                        <label class="required-label">Ảnh hiển thị bên trái</label>
        ...
        <strong><% errors.image[0] %></strong>
                ...
                <div class="form-group text-center">
                    <div class="main-img-preview">
                        <label class="required-label">Ảnh hiển thị bên phải</label>
                        <p class="help-block-img">* Ảnh định dạng: jpg,jpeg,png,webp</p>
