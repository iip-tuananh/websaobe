...
{{--            </div>--}}
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="main-img-preview">
                    <p class="help-block-img">* Ảnh định dạng: jpg,jpeg,png,gif,webp.</p>
                    <img class="thumbnail img-preview" ng-src="<% form.image_mobile.path %>">
                </div>
                <div class="input-group" style="width: 100%; text-align: center">
                    <div class="input-group-btn" style="margin: 0 auto">
                        <div class="fileUpload fake-shadow cursor-pointer">
                            <label class="mb-0" for="<% form.image_mobile.element_id %>">
                                <i class="glyphicon glyphicon-upload"></i> Chọn ảnh
                            </label>
                            <input class="d-none" id="<% form.image_mobile.element_id %>" type="file" class="attachment_upload" accept=".jpg,.jpeg,.png,.gif">
                        </div>
                    </div>
                </div>
                <span class="invalid-feedback d-block" role="alert">
                        <strong><% errors.image_mobile[0] %></strong>
                 </span>
            </div>
