...
<div ng-cloak>
    ...
    {{-- Form tạo mới --}}
    @include('admin.video_block.create')
    @include('admin.video_block.edit')
</div>
@endsection

@section('script')
@include('admin.video_block.Partner')
<script>
    let datatable = new DATATABLE('table-list', {
        ajax: {
            url: '/admin/video-block/searchData',
        ...
        columns: [
            ...
            {data: 'link_youtube', title: 'Link Youtube'},
    ...
    app.controller('Partner', function ($rootScope, $scope, $http) {
        ...
        $('#table-list').on('click', '.edit', function () {
            ...
            $.ajax({
                type: 'GET',
                url: "/admin/video-block/" + $scope.data.id + "/getDataForEdit",
                headers: {
