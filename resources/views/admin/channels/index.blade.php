...
<div ng-cloak>
    ...
    {{-- Form tạo mới --}}
    @include('admin.channels.create')
    @include('admin.channels.edit')
</div>
@endsection

@section('script')
@include('admin.channels.Partner')
<script>
    let datatable = new DATATABLE('table-list', {
        ajax: {
            url: '/admin/channels/searchData',
    ...
    app.controller('Partner', function ($rootScope, $scope, $http) {
        ...
        $('#table-list').on('click', '.edit', function () {
            ...
            $.ajax({
                type: 'GET',
                url: "/admin/channels/" + $scope.data.id + "/getDataForEdit",
                headers: {
