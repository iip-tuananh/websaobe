...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::get('/searchProducts', 'Admin\ProductController@searchProducts')->name('Product.searchProducts');
...
//    });
    ...
    Route::group(['prefix' => 'block-stories'], function () {
        Route::get('/', 'Admin\BlockOneController@index')->name('blockStory.index');
        Route::get('/show', 'Admin\BlockOneController@show')->name('blockStory.show');
        Route::get('/getData', 'Admin\BlockOneController@getData')->name('blockStory.getData');
        Route::post('/update', 'Admin\BlockOneController@update')->name('blockStory.update');
        Route::get('/edit', 'Admin\BlockOneController@edit')->name('blockStory.edit');
    });
    ...
    Route::group(['prefix' => 'certifications'], function () {
        Route::get('/', 'Admin\CertificationController@index')->name('certifications.index');
        Route::get('/searchData', 'Admin\CertificationController@searchData')->name('certifications.searchData');
        Route::get('/{id}/show', 'Admin\CertificationController@show')->name('certifications.show');
        Route::get('/create', 'Admin\CertificationController@create')->name('certifications.create');
        Route::post('/', 'Admin\CertificationController@store')->name('certifications.store');
        Route::post('/{id}/update', 'Admin\CertificationController@update')->name('certifications.update');
        Route::get('/{id}/delete', 'Admin\CertificationController@delete')->name('certifications.delete');
        Route::get('/{id}/getDataForEdit', 'Admin\CertificationController@getDataForEdit');
        Route::get('/exportExcel','Admin\CertificationController@exportExcel')->name('certifications.exportExcel');
    });

    Route::group(['prefix' => 'video-block'], function () {
        Route::get('/', 'Admin\VideoBlockController@index')->name('video_block.index');
        Route::get('/searchData', 'Admin\VideoBlockController@searchData')->name('video_block.searchData');
        Route::get('/{id}/show', 'Admin\VideoBlockController@show')->name('video_block.show');
        Route::get('/create', 'Admin\VideoBlockController@create')->name('video_block.create');
        Route::post('/', 'Admin\VideoBlockController@store')->name('video_block.store');
        Route::post('/{id}/update', 'Admin\VideoBlockController@update')->name('video_block.update');
        Route::get('/{id}/delete', 'Admin\VideoBlockController@delete')->name('video_block.delete');
        Route::get('/{id}/getDataForEdit', 'Admin\VideoBlockController@getDataForEdit');
        Route::get('/exportExcel','Admin\VideoBlockController@exportExcel')->name('video_block.exportExcel');
    });

    Route::group(['prefix' => 'purposes'], function () {
        Route::get('/', 'Admin\PurposeController@index')->name('purposes.index');
        Route::get('/searchData', 'Admin\PurposeController@searchData')->name('purposes.searchData');
        Route::get('/{id}/show', 'Admin\PurposeController@show')->name('purposes.show');
        Route::get('/create', 'Admin\PurposeController@create')->name('purposes.create');
        Route::post('/', 'Admin\PurposeController@store')->name('purposes.store');
        Route::post('/{id}/update', 'Admin\PurposeController@update')->name('purposes.update');
        Route::get('/{id}/delete', 'Admin\PurposeController@delete')->name('purposes.delete');
        Route::get('/{id}/getDataForEdit', 'Admin\PurposeController@getDataForEdit');
        Route::get('/{id}/add-products', 'Admin\PurposeController@addProducts')->name('purposes.addProducts');
        Route::post('submit-add-products', 'Admin\PurposeController@submitAddProducts')->name('purposes.submitAddProducts');
    });

    Route::group(['prefix' => 'block-purpose'], function () {
        Route::get('/{id}/edit', 'Admin\PurposeController@editBlock')->name('purposes.editBlock');
        Route::post('/{id}/update', 'Admin\PurposeController@updateBlock')->name('purposes.updateBlock');
    });
    ...
    Route::group(['prefix' => 'channels'], function () {
        Route::get('/', 'Admin\ChannelController@index')->name('channels.index');
        Route::get('/searchData', 'Admin\ChannelController@searchData')->name('channels.searchData');
        Route::get('/{id}/show', 'Admin\ChannelController@show')->name('channels.show');
        Route::get('/create', 'Admin\ChannelController@create')->name('channels.create');
        Route::post('/', 'Admin\ChannelController@store')->name('channels.store');
        Route::post('/{id}/update', 'Admin\ChannelController@update')->name('channels.update');
        Route::get('/{id}/delete', 'Admin\ChannelController@delete')->name('channels.delete');
        Route::get('/{id}/getDataForEdit', 'Admin\ChannelController@getDataForEdit');
        Route::get('/exportExcel','Admin\ChannelController@exportExcel')->name('channels.exportExcel');
    });
